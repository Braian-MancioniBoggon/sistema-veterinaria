...
export let altaCliente = () =>{

}
export let bajaCliente = () =>{

}
export let modificarCliente = () =>{

}
export let altaPacientes = () =>{

}
export let bajaPaciente = () =>{

}
export let modificarPaciente = () =>{

}
export let altaVeterinaria = () =>{

}
export let bajaVeterinaria = () =>{

}
export let modificarVeterinaria = () =>{

}
export let altaProveedor = () =>{

}
export let bajaProveedor = () =>{

}
export let modificarProveedor = () =>{
